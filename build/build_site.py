...
TOPIC_GUIDES = [
 ...
 {"slug":"taijohoshin-vaccine-hikaku",
  "ev_slug":"elderly_care",
  "body_file":"taijohoshin-vaccine-hikaku.html",
  "h1":"帯状疱疹ワクチンの助成、東京はどうなった？ 定期接種化と50代からの任意接種助成をわかりやすく",
  "title":"帯状疱疹ワクチンの助成を東京の自治体で比較｜定期接種化と50代からの任意接種助成",
  "description":"帯状疱疹ワクチンは2025年4月から定期接種に。対象外の50代は自治体の任意接種助成が頼りです。生ワクチンとシングリックスの助成額、千代田・大田・墨田・中野区の実例と公式出典つきで、東京の自治体差と確認方法を解説します。",
  "rel_kind":"health",
  "faq":[
    ("帯状疱疹ワクチンは無料になったのですか？",
     "2025年4月から、その年度に65歳になる方などが定期接種の対象になり、自治体が定めた自己負担（無料〜数千円程度）で接種できます。対象は65歳や、経過措置の節目年齢（70・75・80歳など）に限られます。"),
    ("50代ですが助成の対象になりますか？",
     "定期接種は65歳などが中心のため50代は対象外のことが多いですが、東京都内では多くの自治体が50歳以上への「任意接種」費用助成を続けています。対象年齢・金額は自治体で異なります。"),
    ("ワクチンの種類で助成額は違いますか？",
     "生ワクチン（1回）とシングリックス（不活化・2回）で助成額が分かれるのが一般的です。任意接種助成では生ワクチンは4,000円前後、シングリックスは1回あたり1万円前後を助成する自治体が多く見られます（自治体で異なります）。"),
    ("助成は何度でも受けられますか？",
     "「生涯1度限り」「過去に帯状疱疹ワクチンの助成を受けた方・接種済みの方は対象外」とする自治体が多く、すでに接種した方は対象になりません。"),
    ("手続きはどうすればよいですか？",
     "多くの自治体で、事前に予診票の交付申請（電子申請・電話・窓口など）が必要です。契約医療機関で接種し、窓口で助成分が差し引かれるのが一般的な流れです。予診票の到着に1〜2週間かかることもあります。"),
  ]},
 {"slug":"sango-care-hikaku",
  "ev_slug":"pregnancy_birth",
  "body_file":"sango-care-hikaku.html",
  "h1":"産後ケア事業は東京の自治体でどう違う？ 宿泊・通所・訪問の料金と対象を比べてわかること",
  "title":"産後ケア事業を東京の自治体で比較｜宿泊・通所・訪問の料金と対象の違い",
  "description":"東京都の産後ケア事業を、宿泊・通所（デイ）・訪問の3つの型と自己負担額で比較。板橋・渋谷・練馬区の料金や、非課税世帯の減免、対象期間の違いを公式出典つきで解説します。",
  "faq":[
    ("産後ケアはどんなことをしてもらえますか？",
     "助産師などの専門職から、母体の休養・回復のケアや、授乳・育児の相談を受けられます。提供の形は、施設に泊まる宿泊型、日中に通う通所（デイ）型、自宅を訪ねてもらう訪問型の3つが中心です。"),
    ("費用はいくらかかりますか？",
     "自己負担は自治体で異なります。宿泊型は1泊2日7,000〜8,000円程度が目安の区が多く、通所型は1回1,500〜2,000円、訪問型は1回500〜1,000円程度が目安です。基本無料の区や、施設ごとに料金が異なる区もあります。"),
    ("住民税非課税世帯や生活保護世帯の減免はありますか？",
     "多くの自治体で、住民税非課税世帯・生活保護世帯は自己負担が減免（多くは全額免除）されます。詳しい適用条件は各自治体の公式ページで確認してください。"),
    ("いつまで利用できますか？",
     "対象期間は自治体で異なり、産後4〜5か月までとする例や、型ごとに期間が分かれる例（訪問型は産後1年未満など）があります。利用回数にも上限が設けられているのが一般的です。"),
    ("申し込みはどうすればよいですか？",
...
SPECIAL_FEATURES = [
 {"slug":"2026-koko-mushoka",
  "badge":"教育費・高校無償化",
  "updated":"2026-08-27",
  "body_file":"2026-koko-mushoka.html",
  "h1":"高校授業料の実質無償化はどう変わった？ 2026年度からの所得制限撤廃をわかりやすく",
  "title":"高校無償化2026をわかりやすく｜所得制限撤廃・私立45万7,200円・東京都の上乗せ",
  "description":"2026年4月から高等学校等就学支援金の所得制限が撤廃され、全世帯が対象に。公立は実質無償、私立は支給上限が45万7,200円へ。国の就学支援金と東京都の授業料軽減助成金の組み合わせ、申請の注意点まで公式情報をもとに解説します。",
  "lead":"高校授業料を支える「高等学校等就学支援金」は、2026年4月から所得制限が撤廃され、全世帯が対象になりました。公立は実質無償、私立は支給上限が引き上げられ、東京都は独自の助成でさらに上乗せしています。何がどう変わったのか、いくら支援されるのか、申請の注意点までを整理しました。",
  "faq":[
    ("2026年から高校無償化はどう変わりましたか？",
     "高等学校等就学支援金の所得制限が2026年4月に完全撤廃され、世帯の所得に関係なく全世帯が対象になりました。あわせて私立の支給上限が年39万6,000円から45万7,200円（私立の全国平均授業料相当）へ引き上げられ、公立は年11万8,800円で実質授業料が無償になります。"),
    ("私立高校は完全に無料になりますか？",
     "対象は授業料のみで、入学金・施設設備費・教材費などは対象外です。授業料が国（および都の助成）の支給上限を超える学校では、その差額は保護者の負担になります。上限額と学校の授業料を必ず確認してください。"),
    ("東京都に住んでいる場合はどうなりますか？",
     "東京都は国の就学支援金に都独自の授業料軽減助成金を上乗せし、都内私立高校の平均授業料相当を上限に支援します。2026年度から年収910万円以上を含む全世帯が対象になり、所得制限のない私立高校等授業料支援の申請受付が2026年6月1日から始まっています。"),
    ("手続きは必要ですか？",
     "就学支援金も都の助成も申請が必要で、自動では始まりません。多くは入学後の春に学校やオンライン（東京都は専用システム）で手続きし、収入確認のためマイナンバー関連書類の提出を求められます。期日を過ぎるとその期間分を受けられないことがあるため早めに手続きしてください。"),
  ],
  "sources":[
    ("文部科学省：高校生等への修学支援（就学支援金）","https://www.mext.go.jp/a_menu/shotou/mushouka/index.htm"),
    ("東京都：所得制限のない私立高校等授業料支援（6月1日オンライン申請開始）","https://www.metro.tokyo.lg.jp/information/press/2026/05/2026052927"),
    ("補助金ポータル：高校授業料無償化2026（所得制限撤廃・私立45万7,200円）","https://hojyokin-portal.jp/columns/koko_mushoka"),
    ("リセマム：高校無償化、2026年度にどう変わる？","https://resemom.jp/article/2025/07/04/82488.html"),
  ]},
 {"slug":"2026-jutaku-shoene",
  "badge":"住まい・省エネ補助",
  "updated":"2026-08-27",
  "body_file":"2026-jutaku-shoene.html",
  "h1":"住宅省エネ2026で最大200万円超？ 断熱・窓・給湯器の補助をまとめて解説",
  "title":"住宅省エネ2026キャンペーンを解説｜みらいエコ住宅・窓リノベ・給湯省エネの補助額と併用",
  "description":"国の住宅向け省エネ補助「住宅省エネ2026キャンペーン」を解説。みらいエコ住宅2026（新築125万・リフォーム100万）・先進的窓リノベ2026（最大100万円）・給湯省エネ2026の補助額、併用（ワンストップ申請）、対象時期・予算上限の注意点までまとめました。",
  "lead":"断熱リフォームや窓の交換、高効率給湯器の導入に使える国の大型補助「住宅省エネ2026キャンペーン」を整理しました。3つの事業を組み合わせると合計200万円を超える補助になることもあります。金額・対象・申請の流れと、予算上限による早期終了の注意点までまとめます。",
  "faq":[
    ("住宅省エネ2026キャンペーンとは何ですか？",
     "国（国土交通省・経済産業省・環境省）の住宅向け省エネ補助をまとめた枠組みで、みらいエコ住宅2026事業（断熱改修・省エネ新築）、先進的窓リノベ2026（窓の断熱）、給湯省エネ2026（高効率給湯器）の3事業が中心です。条件を満たせば1回の工事で併用（ワンストップ申請）できます。"),
    ("いくらもらえますか？",
     "目安として、みらいエコ住宅2026は新築で最大125万円・リフォームで最大100万円、先進的窓リノベ2026は最大100万円、給湯省エネ2026は機器の性能区分により数万〜十数万円（エネファームは最大17万円前後）です。3事業併用で合計200万円超になるケースもあります。"),
    ("自分で申請するのですか？",
     "いいえ。補助金は原則として登録された施工事業者が申請し、値引きなどで還元されます。対象工事や補助額の可否は施工会社に確認してください。"),
    ("いつまでに動けばよいですか？",
     "公式の受付期限は2026年12月31日ですが、予算上限に達すると早期終了します。対象は2025年11月28日以降に着手した工事などで、人気事業のため早めの相談・着手が安全です。"),
  ],
  "sources":[
    ("住宅省エネ2026キャンペーン（国 公式サイト）","https://jutaku-shoene2026.mlit.go.jp/"),
    ("リショップナビ：住宅省エネ2026キャンペーン（補助額・開始時期）","https://rehome-navi.com/articles/3633"),
    ("生活堂：先進的窓リノベ2026事業（最大100万円）","https://www.seikatsu-do.com/information/jutaku-shoene2026/window-renovation2026.php"),
    ("リフォーム補助金ナビ：給湯省エネ2026事業","https://reform-hojo.jp/news/kyutou-shoene-2026-guide"),
  ]},
 {"slug":"2026-tokyo-funin-ranshi",
  "badge":"妊娠・出産・不妊治療",
  "updated":"2026-08-27",
  "body_file":"2026-tokyo-funin-ranshi.html",
  "h1":"東京都の不妊治療助成が2026年4月に拡充｜保険の自己負担分・卵子凍結・不育症まで",
  "title":"東京都の不妊治療・卵子凍結助成2026｜保険自己負担分に上限15万円・国の卵子凍結モデル事業も",
  "description":"東京都は2026年4月から不妊治療支援を拡充。保険診療の体外受精・顕微授精の自己負担分も1回上限15万円まで助成対象に。卵子凍結費用助成（凍結時最大20万円＋保管料年2万円）、不育症検査助成、国の卵子凍結モデル事業（令和8年度・18〜35歳）まで解説します。",
  "lead":"東京都は2026年4月から、不妊治療への支援を大きく拡充しました。保険診療の自己負担分も助成対象に加わり、卵子凍結や不育症検査の助成、国の新しい卵子凍結モデル事業もあります。何が対象で、どこに注意すべきかを整理しました。",
  "faq":[
    ("2026年4月から何が変わりましたか？",
     "東京都は、保険適用の体外受精・顕微授精などにかかる自己負担分についても、1回あたり上限15万円まで助成する仕組みを加えました。従来からの卵子凍結費用助成・不育症検査助成とあわせて支援が手厚くなっています。"),
    ("卵子凍結の助成はいくらですか？",
     "東京都独自の助成として、卵子凍結時に最大20万円、加えて保管料を年2万円程度助成する枠組みがあります（対象年齢・回数などの条件があります）。国も令和8年度から18〜35歳の未婚女性などを対象にした卵子凍結モデル事業を始めます。"),
    ("誰でも対象になりますか？",
     "治療開始時の年齢や助成回数の上限、指定医療機関での治療かどうかなど条件があります。国のモデル事業と都の助成は対象範囲・併用の可否が異なるため、医療機関や自治体の案内で自分がどの制度の対象になるか確認してください。"),
  ],
  "sources":[
    ("torch clinic：東京都の不妊治療助成が拡充（2026年4月・上限15万円）","https://www.torch.clinic/contents/1967"),
    ("はらメディカルクリニック：卵子凍結の補助金（国モデル事業・東京都）2026年版","https://www.haramedical.or.jp/column/ranshijosei.html"),
    ("こども家庭庁（公式）","https://www.cfa.go.jp/"),
  ]},
 {"slug":"2026-tokyo-solar-chikuden",
  "badge":"住まい・省エネ補助",
  "updated":"2026-08-27",
  "body_file":"2026-tokyo-solar-chikuden.html",
  "h1":"東京都の太陽光・蓄電池・V2H補助（令和8年度）｜単価と上限、申請時期のまとめ",
  "title":"東京都の太陽光・蓄電池補助2026｜太陽光15万円/kW・蓄電池10万円/kWh・V2Hの上限と申請時期",
  "description":"東京都（クール・ネット東京）の令和8年度 家庭向け太陽光・蓄電池・V2H補助を解説。太陽光は最大15万円/kW、蓄電池は10万円/kWh（新設上限120万円・増設72万円）。事前申込2026年5月29日・交付申請6月30日開始、予算上限による終了や区市町村の上乗せまで整理します。",
  "lead":"電気代高騰と防災の観点で関心が高い、家庭用の太陽光発電・蓄電池・V2H。東京都の令和8年度補助は全国でも手厚い水準です。補助単価・上限、申請の時期、予算上限による早期終了の注意点までまとめました。",
  "faq":[
    ("東京都の補助はいくらですか？",
     "目安として、太陽光発電は既存住宅で最大15万円/kW、家庭用蓄電池は10万円/kWh（新設で1戸あたり上限120万円、増設は上限72万円）です。EVを住宅の電源に使うV2Hへの補助もあります。金額は容量や機種で変わります。"),
    ("いつ申請すればよいですか？",
     "令和8年度は事前申込が2026年5月29日、交付申請兼実績報告が2026年6月30日から受付開始とされています。工事前の手続きが必要な場合があるため、契約・着工の前に要件を確認してください。予算上限に達すると受付は終了します。"),
    ("区市町村の補助も使えますか？",
     "都の補助に加えて、お住まいの区市町村が独自に上乗せ補助を行う場合があります。両方の制度を確認すると、より負担を抑えられます。"),
  ],
  "sources":[
    ("ソーラーパートナーズ：令和8年度 東京都の太陽光・蓄電池補助金","https://www.solar-partners.jp/contents/97775.html"),
    ("東京ガス：家庭用蓄電池の補助金一覧（2026年）","https://solar-battery.tokyo-gas.co.jp/column/0071/"),
    ("クール・ネット東京（東京都環境公社 公式）","https://www.tokyo-co2down.jp/"),
  ]},
 {"slug":"2026-reskilling-shien",
  "badge":"仕事・学び直し",
  "updated":"2026-08-27",
  "body_file":"2026-reskilling-shien.html",
  "h1":"リスキリング（学び直し）に使える給付・助成2026｜個人は最大80%、企業向けも拡充",
  "title":"リスキリング支援2026を解説｜教育訓練給付 最大80%・人材開発支援助成金の拡充",
  "description":"学び直し（リスキリング）に使える公的支援を、個人向けの教育訓練給付（専門実践 最大80%・年上限64万円ほか）と、企業向けの人材開発支援助成金（2026年3月に事業展開等リスキリング支援コースを大幅拡充）に分けて解説。対象・給付率・申請の注意点までまとめました。",
  "lead":"スキルを身につけ直す「リスキリング」への公的支援が拡充されています。個人が使う教育訓練給付と、企業が従業員の訓練費に使う人材開発支援助成金の2本柱を、給付率や申請の注意点まで整理しました。",
  "faq":[
    ("個人が使える支援はどれくらい戻りますか？",
     "教育訓練給付では、専門実践教育訓練で受講費用の最大80%（受講後に賃金が上がるとさらに上乗せ、年上限64万円）、特定一般教育訓練で最大50%（上限25万円）、一般教育訓練で20%（上限10万円）が支給されます。引き上げ後の給付率は2024年10月1日以降に受講開始した講座が対象です。"),
    ("企業向けの助成は何が変わりましたか？",
     "人材開発支援助成金の「事業展開等リスキリング支援コース」が2026年3月に拡充され、事業展開計画がなくても将来従事する予定の職務に関連する訓練が対象になり、中小企業でも使いやすくなりました。ただしリスキリング関連の一部類型は2026年度で終了予定です。"),
    ("申請で気をつけることは？",
     "個人は受講開始前に対象講座か・支給要件を満たすかをハローワークで確認し、受講後に申請します。企業は訓練実施前に計画届の提出が必要なコースが多く、事後申請では対象外になることがあります。"),
  ],
  "sources":[
    ("厚生労働省：教育訓練給付制度","https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/koyou_roudou/jinzaikaihatsu/kyouiku.html"),
    ("補助金ポータル：教育訓練給付金とは（2026年）","https://hojyokin-portal.jp/columns/kyoiku_kunren_kyufu"),
    ("社労士事務所リッシュ：人材開発支援助成金 リスキリング支援コース大幅拡充（2026年）","https://riche-sr.com/1530/"),
  ]},
...
EV_PHOTO = {
 "pregnancy_birth": ("preg-birth.jpg", "産院で新生児を抱く母親"),
 "childcare": ("child-hoiku.jpg", "保育園の室内で遊ぶ子どもたち"),
 "moving": ("moving-boxes.jpg", "引越し用段ボール箱"),
 "retirement_unemployment": ("job-shurou.jpg", "職業訓練の指導風景"),
 "elderly_care": ("eld-home-care.jpg", "在宅介護の様子"),
}
# 比較カテゴリごとの上書き（無い場合はライフイベント写真へフォールバック）
CAT_PHOTO = {
 "preg_kenshin": ("preg-boshi-techo.jpg", "母子健康手帳"),
 "preg_gift": ("preg-birth.jpg", "産院で新生児を抱く母親"),
 "preg_shussanhi": ("preg-birth.jpg", "産院で新生児を抱く母親"),
 "preg_sango_care": ("preg-sango-care.jpg", "産後ケアの様子"),
 "preg_funin": ("preg-funin-consult.jpg", "不妊・不育治療助成の相談窓口"),
 "preg_tamondo": ("preg-tamondo-support.jpg", "多胎児家庭支援の相談窓口"),
 "child_teate": ("child-parent.jpg", "親子がノートPCを見る様子"),
 "child_fuyou": ("child-parent.jpg", "親子がノートPCを見る様子"),
 "child_iryo": ("child-iryo-clinic.jpg", "子ども医療費助成の窓口"),
 "child_hitorioya": ("child-hitorioya-clinic.jpg", "ひとり親家庭医療費助成の窓口"),
 "child_shugaku": ("child-study-desk.jpg", "学習デスク"),
 "child_hoiku_gen": ("child-hoiku.jpg", "保育園の室内で遊ぶ子どもたち"),
 "child_ninkagai": ("child-ninkagai.jpg", "認可外保育・ベビーシッター"),
 "child_iwai": ("child-iwai-coupon.jpg", "出産・入学祝金と子育てクーポン"),
 "child_shogakukin": ("child-study-desk.jpg", "学習デスク"),
 "child_omutsu_baby": ("child-omutsu-milk.jpg", "乳児用おむつとミルク・哺乳瓶"),
 "child_ikusei": ("child-parent.jpg", "親子がノートPCを見る様子"),
 "house_juukyo": ("house-rent.jpg", "賃貸借契約書と鍵"),
 "house_yachin": ("house-rent.jpg", "賃貸借契約書と鍵"),
 "house_sansedai": ("house-sansedai.jpg", "二世帯住宅の外観"),
 "house_reform": ("house-reform.jpg", "住宅の手すり設置工事"),
 "house_taishin": ("house-taishin.jpg", "耐震補強工事"),
 "house_eco": ("house-solar.jpg", "住宅の太陽光パネル"),
 "job_kokuho": ("procedure-cityhall.jpg", "国保・年金の市区町村窓口"),
 "job_nenkin": ("procedure-cityhall.jpg", "市区町村窓口の受付"),
 "job_shurou": ("job-shurou.jpg", "職業訓練の指導風景"),
 "job_kashitsuke": ("job-kashitsuke-consult.jpg", "緊急小口貸付の相談窓口"),
 "job_konkyu": ("job-kashitsuke-consult.jpg", "生活困窮者自立支援の相談窓口"),
 "job_shobyo": ("med-clinic-waiting.jpg", "医療機関の受付・待合"),
 "med_kogaku": ("dis-iryo-hospital.jpg", "医療費助成の申請窓口"),
 "med_sosai": ("med-sosai.jpg", "葬儀場の祭壇"),
 "eld_omutsu": ("eld-omutsu.jpg", "高齢者向け紙おむつなどの介護用品"),
 "eld_kaigo_gen": ("eld-kaigo-consult.jpg", "介護保険料減免の相談窓口"),
 "eld_hochoki": ("eld-hochoki.jpg", "補聴器と充電ケース"),
 "eld_jutaku": ("house-reform.jpg", "住宅の手すり設置工事"),
 "eld_vaccine": ("eld-vaccine-consult.jpg", "高齢者ワクチン助成の窓口"),
 "eld_kinkyu": ("eld-home-care.jpg", "在宅介護の様子"),
 "eld_haishoku": ("eld-haishoku.jpg", "配食弁当"),
 "eld_iwai": ("eld-iwai-consult.jpg", "敬老祝い金の相談窓口"),
 "eld_yougu": ("eld-care-equipment.jpg", "車いす・介護ベッドなどの介護用品"),
 "dis_iryo": ("dis-iryo-hospital.jpg", "重度心身障害者医療費助成の申請窓口"),
 "dis_yougu": ("eld-care-equipment.jpg", "車いす・歩行器などの福祉用具"),
 "dis_teate": ("dis-teate-consult.jpg", "心身障害者手当の相談窓口"),
 "low_aircon": ("eld-aircon.jpg", "室内に設置されたエアコン"),
 "low_taxi": ("low-taxi.jpg", "タクシー乗り場"),
}
...
""")
    ...
    for t in TOPIC_GUIDES:
        ...
        ev_guide_slug = {g[1]: g[0] for g in GUIDES_EV}.get(ev_slug, ev_slug)
        rel = (f'<h2>{esc(ev_name)}の制度を自治体で比べる</h2>'
               f'<p>東京都62自治体の{esc(ev_name)}に関する制度は、制度カテゴリの比較・一覧から確認できます。'
               ...
               f'<li><a href="/ranking/{ev_slug}/">{esc(ev_name)}の制度がある自治体をみる '+CHEV_R+'</a></li>'
               f'<li><a href="/guide/{ev_guide_slug}/">{esc(ev_name)}の基礎知識ガイド '+CHEV_R+'</a></li>'
               '</ul></div>')
...
KURASHI_INDS = [
    ...
    ("nenshou_rate", "年少人口率（15歳未満の割合）", "%", "rate",
     "総人口に占める0〜14歳の割合（高い順）。子育て世帯の多さ・まちの若さの目安です。",
     "年少人口率が高いほど、子育て世帯が多く子ども向けの環境が整いやすい傾向があります。"),
    ("koreika_rate", "高齢化率（65歳以上の割合）", "%", "rate",
     "総人口に占める65歳以上の割合（高い順）。医療・介護・シニア向け施策の背景の目安です。",
     "高齢化率が高い自治体ほど、シニア向けの制度・サービスの重要性が高まります。"),
...
/* ── SVGグラフ ── */
.chartcard{border:1px solid var(--line);border-radius:var(--radius);padding:.7rem .8rem .4rem;margin:.6rem 0;--pc:var(--accent);display:flex;flex-direction:column;align-items:center}
...
.cmpchart{margin:1rem 0 1.2rem;padding:.85rem 1rem .7rem;border:1px solid var(--line);border-left:4px solid var(--pc,var(--accent));border-radius:var(--radius);background:var(--bg);display:flex;flex-direction:column;align-items:center}
.cmpchart figcaption{font-weight:var(--fw-bold);font-size:var(--fs-md);margin:0 0 .5rem;color:var(--fg);align-self:stretch;max-width:640px;width:100%}
.cmpchart .chart{max-width:640px;margin:0 auto}
.cmpchart .chart .c-val{fill:var(--fg);font-weight:var(--fw-semi)}
.cmpchart .c-cap{font-size:var(--fs-xs);color:var(--muted);margin:.5rem 0 0;line-height:1.6;align-self:stretch;max-width:640px;width:100%}
.covchart{margin:1rem 0 1.2rem;padding:.85rem 1rem .7rem;border:1px solid var(--line);border-left:4px solid var(--pc,var(--accent));border-radius:var(--radius);background:var(--bg);display:flex;flex-direction:column;align-items:center}
.covchart figcaption{font-weight:var(--fw-bold);font-size:var(--fs-md);margin:0 0 .6rem;color:var(--fg);align-self:stretch;max-width:640px;width:100%}
.covbars{list-style:none;margin:0 auto;padding:0;display:grid;gap:.5rem;max-width:640px;width:100%}
...
.covchart .c-cap{font-size:var(--fs-xs);color:var(--muted);margin:.6rem 0 0;line-height:1.6;align-self:stretch;max-width:640px;width:100%}
