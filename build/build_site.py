...
TAXONOMY = [
 ...
 ("child_iryo","子ども・乳幼児医療費助成","childcare",["子ども医療費","乳幼児医療","子育て医療","義務教育就学児医療","高校生等医療","マル子","マル乳","こども医療費","子供医療費","子どもの医療費","子ども等医療"],[]),
 ...
 ("eld_kinkyu","緊急通報システム・見守り","elderly_care",["緊急通報","見守り","徘徊","位置探索","認知症高齢者位置","声かけ","自動通話録音","通話録音装置"],[]),
